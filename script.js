function myFunction() {
    ...
    const url='https://sensordata-a125f-default-rtdb.firebaseio.com/Temperature_data.json';
...
function myFunction2() {
    ...
    //console.log(selectedDate);
    const Http = new XMLHttpRequest();
    const url='https://sensordata-a125f-default-rtdb.firebaseio.com/Humidity_data.json';
